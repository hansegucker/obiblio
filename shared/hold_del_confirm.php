...
<center>
    <form name="delbiblioform" method="POST" action="<?php echo H($returnUrl); ?>">
        ...
        <br><br>
        <input type="button"
               onClick="self.location='../shared/hold_del.php?bibid=<?php echo H(addslashes(U($bibid))); ?>&amp;copyid=<?php echo H(addslashes(U($copyid))); ?>&amp;holdid=<?php echo H(addslashes(U($holdid))); ?>&amp;mbrid=<?php echo H(addslashes(U($mbrid))); ?>'"
               value="<?php echo $loc->getText("sharedDelete"); ?>" class="button">
