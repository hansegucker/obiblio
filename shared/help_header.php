...
<table class="primary" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr bgcolor="<?php echo H(OBIB_TITLE_BG); ?>">
        ...
        <td class="title" valign="top" nowrap="yes"><font class="small"><a href="javascript:window.close()"><font
                            color="<?php echo H(OBIB_TITLE_FONT_COLOR) ?>"><?php echo $loc->getText("helpHeaderCloseWin"); ?></font></a>&nbsp;&nbsp;</font>
        </td>
    </tr>
</table>
<!-- **************************************************************************************
...
<table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td bgcolor="<?php echo H(OBIB_ALT1_BG); ?>"><img src="../images/shim.gif" width="80" height="1" border="0">
        </td>
    ...
    <tr>
        ...
        <td valign="top" bgcolor="<?php echo H(OBIB_ALT1_BG); ?>">
            <font class="alt1">
                ...
                <a href="http://obiblio.sourceforge.net/index.php/Help/<?php echo HURL($_GET["page"]);; ?>"
                   target=_blank>Revise Page</a>
                <font class="error"><font class="small">(<?php echo $loc->getText("wiki updates to this page"); ?>
                        )</font></font><br>
            </font>
        </td>
        <td bgcolor="<?php echo H(OBIB_BORDER_COLOR); ?>"><img src="../images/shim.gif" width="1" height="1" border="0">
