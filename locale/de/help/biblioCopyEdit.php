...
<table class="primary">
    ...
    <tr>
        ...
        <td class="primary" valign="top">Eindeutiger Code, der ein Exemplar identifiziert,
            maximal 20 Zeichen. Dieses Feld ist eine Pflichtangabe, weil es das Exemplar bei der Ausleihe, R�ckgabe und
            Vorbestellung identifiziert.
            <br>Siehe auch:
...
<ul>
    <li>Entweder den Barcode manuell eingeben oder einen Barcodescanner verwenden, wenn das Exemplar schon einen Barcode
        hat,
    </li>
...
<a name="auto">
    Wenn man bei einem neues Exemplar die Funktion <input name="autobarco" type="checkbox" checked> Autom.
    Generierung</a>
...
<ul>
    <li>Der erste Teil wird dabei aus der <i>Medien-ID</i> errechnet, die das Medium in
        ...
        indem man den Wert $nzeros in biblio_copy_new.php �ndert.
    </li>
...
<a name="seri">
    Das Kopieren von Seriennummern, die in Barcodes integriert
    sind</a> erleichtert die Eingabe von Exemplaren aus einer einfachen Kartei, wenn keine eindeutigen Nummern vergeben wurden, sondern nur Seriennummern f�r mehrere Exemplare eines Titels.
<br>
...
<ul>
    ...
    <li>solange neue Kopien anlegen, bis die letzten Stellen des generierten Code mit der Seriennummer �bereinstimmen,
    </li>
