...
#****************************************************************************
$trans["biblioFieldError1"] = "\$text = 'Das Feld wird benöötigt.';";
...
$trans["labelFormatFontSizeErr"] = "\$text = 'Ungültige Schriftgröße in der Etikettendefinitionsdatei. Die Schriftgröße muss numerisch sein.';";
$trans["labelFormatFontSizeErr2"] = "\$text = 'Ungültige Schriftgröße in der Etikettendefinitionsdatei. Die Schriftgröße muss größer als Null sein.';";
$trans["labelFormatLMarginErr"] = "\$text = 'Ungültiger linker Rand in der Etikettendefinitionsdatei. Der linke Rand muss numerisch sein.';";
$trans["labelFormatLMarginErr2"] = "\$text = 'UngÜltiger linker Rand in der Etikettendefinitionsdatei. Der linke Rand muss größer als Null sein.';";
$trans["labelFormatRMarginErr"] = "\$text = 'Ungültiger rechter Rand in der Etikettendefinitionsdatei. Der rechte Rand muss numerisch sein.';";
$trans["labelFormatRMarginErr2"] = "\$text = 'Ungültiger rechter Rand in der Etikettendefinitionsdatei. Der rechte Rand muss größer als Null sein.';";
$trans["labelFormatTMarginErr"] = "\$text = 'Ungültiger oberer Rand in der Etikettendefinitionsdatei. Der obere Rand muss numerisch sein.';";
$trans["labelFormatTMarginErr2"] = "\$text = 'Ungültiger oberer Rand in der Etikettendefinitionsdatei. Der obere Rand muss größer als Null sein.';";
$trans["labelFormatBMarginErr"] = "\$text = 'Ungültiger unterer Rand in der Etikettendefinitionsdatei. Der untere Rand muss numerisch sein.';";
$trans["labelFormatBMarginErr2"] = "\$text = 'Ungültiger unterer Rand in der Etikettendefinitionsdatei. Der untere Rand muss größer als Null sein.';";
...
$trans["labelFormatWidthErr"] = "\$text = 'Ungültige Breite in der Etikettendefinitionsdatei. Die Breite muss numerisch sein.';";
$trans["labelFormatWidthErr2"] = "\$text = 'Ungültige Breite in der Etikettendefinitionsdatei. Die Breite muss größer als Null sein.';";
$trans["labelFormatHeightErr"] = "\$text = 'Ungültige Höhe in der Etikettendefinitionsdatei. Die Höhe muss numerisch sein.';";
$trans["labelFormatHeightErr2"] = "\$text = 'Ungültige Höhe in der Etikettendefinitionsdatei. Die Höhe muss größer als Null sein.';";
...
$trans["memberAccountTransError2"] = "\$text = 'Der Betrag muss numerisch sein.';";
$trans["memberAccountTransError3"] = "\$text = 'Die Beschreibung wird benötigt.';";
$trans["Amount must be greater than zero."] = "\$text = 'Der Betrag muss größer als Null sein.';";
