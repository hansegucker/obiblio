...
<table class="primary">
    ...
    <tr>
        ...
        <td class="primary" valign="top">Check this if you wish to have this library item show up on OPAC (online public
            access catalog) searches.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="primary" valign="top">Person, persons or organization reponsible for producing a work, such as an
            author or list of author(s), editors, contributors, illustrator(s) etc.
        </td>
    </tr>
    <tr>
        ...
        <td class="primary" valign="top">A personal name used as a main entry in a bibliographic record.
            ...
            so you will want to be sure to code the last name first.
        </td>
    </tr>
