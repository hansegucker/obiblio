...
<table class="primary" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr bgcolor="<?php echo H(OBIB_TITLE_BG); ?>">
        ...
        <td class="title" valign="top" nowrap="yes"><font class="small"><a href="javascript:window.close()"><font
                            color="<?php echo H(OBIB_TITLE_FONT_COLOR) ?>"><?php echo $loc->getText("usmarcCloseWindow"); ?></font></a>&nbsp;&nbsp;</font>
        </td>
    </tr>
</table>
<!-- **************************************************************************************
            ...
            if (strcmp($selectedBlock, $blockKey) == 0) {
                ...
                if ($marcTags != false) {
                    foreach ($marcTags as $tagKey => $tag) {
                        ...
                        if (strcmp($selectedTag, $tagKey) == 0) {
                            ...
                            <tr>
                                ...
                                <td class="noborder" nowrap>
                                    <a href="../catalog/usmarc_select.php?retpage=<?php echo HURL($retPage); ?>&amp;block=<?php echo HURL($blockKey); ?>"
                                       class="nav">
                                        -&nbsp;</a>
                                </td>
                            ...
                            if ($marcSubflds != false) {
                                foreach ($marcSubflds as $subfldKey => $subfld) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="noborder">
                                            <a href="javascript:backToMain('<?php echo H(addslashes($retPage . $sepchar . "tag=" . U($selectedTag) . "&subfld=" . U($subfld->getSubfieldCd()) . "&descr=" . U($subfld->getDescription()))) ?>')"
                                               class="nav">
                                                <?php echo $loc->getText("usmarcSelectUse"); ?></a>
                                        </td>
                                        <td class="noborder" width="100%">
                                            <?php echo H($subfld->getSubfieldCd() . " - " . $subfld->getDescription()); ?></a>
                                            <br>
                                        </td>
                                    </tr>
                                    <?php
                            ...
                            <tr>
                                <td class="noborder"></td>
                                <td class="noborder">
                                    <a href="../catalog/usmarc_select.php?retpage=<?php echo HURL($retPage); ?>&amp;block=<?php echo HURL($blockKey); ?>&amp;tag=<?php echo HURL($tagKey); ?>"
                                       class="nav">
                                        +</a>
                                </td>
                    ...
                    <tr>
                        ...
                        <td class="noborder" colspan="3" width="100%">
                            <?php echo $loc->getText("usmarcSelectNoTags"); ?>
                        </td>
                    </tr>
