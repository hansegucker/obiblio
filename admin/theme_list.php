    ...
    while ($theme = $themeQ->fetchTheme()) {
        ...
        <tr>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <a href="../admin/theme_edit_form.php?themeid=<?php echo HURL($theme->getThemeid()); ?>"
                   class="<?php echo H($row_class); ?>"><?php echo $loc->getText("adminTheme_Edit"); ?></a>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <a href="../admin/theme_new_form.php?themeid=<?php echo HURL($theme->getThemeid()); ?>"
                   class="<?php echo H($row_class); ?>"><?php echo $loc->getText("adminTheme_Copy"); ?></a>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <?php if ($theme->getThemeid() == OBIB_THEMEID) {
                    echo $loc->getText("adminTheme_Del");
                } else { ?>
                    <a href="../admin/theme_del_confirm.php?themeid=<?php echo HURL($theme->getThemeid()); ?>&amp;name=<?php echo HURL($theme->getThemeName()); ?>"
                       class="<?php echo H($row_class); ?>"><?php echo $loc->getText("adminTheme_Del"); ?></a>
                <?php } ?>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
...
<table class="primary">
    <tr>
        <td valign="top" class="noborder"><font class="small"><?php echo $loc->getText("adminTheme_Note"); ?></font>
        </td>
