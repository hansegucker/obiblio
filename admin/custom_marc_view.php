...
?>
<br>
<a href="custom_marc_add_form.php?materialCd=<?php echo HURL($materialCd); ?>&amp;reset=Y">Add a custom MARC Field to
    this material type</a> (<?php echo H($dm->getDescription()); ?>)<br><br>
<?php
