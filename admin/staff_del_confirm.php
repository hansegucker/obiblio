...
<center>
    <form name="delstaffform" method="POST"
        ...
        <?php echo $loc->getText("adminStaff_del_confirmConfirmText"); ?><?php echo H($first_name); ?> <?php echo H($last_name); ?>
        ?<br><br>
        <input type="submit" value="  <?php echo $loc->getText("adminDelete"); ?>  " class="button">
        <input type="button" onClick="self.location='../admin/staff_list.php'"
