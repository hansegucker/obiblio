...
<center>
    <form name="delstaffform" method="POST"
          action="../admin/copy_fields_del.php?code=<?php echo HURL($code); ?>&amp;desc=<?php echo HURL($description); ?>">
        ...
        <input type="button" onClick="self.location='../admin/copy_fields_list.php'"
