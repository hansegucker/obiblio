...
?>
<a href="../admin/collections_new_form.php?reset=Y"><?php echo $loc->getText("adminCollections_listAddNewCollection"); ?></a>
<br>
    ...
    foreach ($dms as $dm) {
        ...
        <tr>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <a href="../admin/collections_edit_form.php?code=<?php echo HURL($dm->getCode()); ?>"
                   class="<?php echo H($row_class); ?>"><?php echo $loc->getText("adminCollections_listEdit"); ?></a>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <?php if ($dm->getCount() == 0) { ?>
                    <a href="../admin/collections_del_confirm.php?code=<?php echo HURL($dm->getCode()); ?>&amp;desc=<?php echo HURL($dm->getDescription()); ?>"
                       class="<?php echo H($row_class); ?>"><?php echo $loc->getText("adminCollections_listDel"); ?></a>
                <?php } else {
                    echo $loc->getText("adminCollections_listDel");
                } ?>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
...
<table class="primary">
    <tr>
        <td valign="top" class="noborder"><font
                    class="small"><?php echo $loc->getText("adminCollections_ListNote"); ?></font></td>
