...
<p class="flow-text">
    ...
    <em><?php echo H( $staff->getFirstName() ); ?><?php echo H( $staff->getLastName() ); ?></em><?php echo $loc->getText( "adminStaff_editUpdated" ); ?>
</p>


<a href="../admin/staff_list.php" class="waves-effect waves-light btn">
	<?php echo $loc->getText( "adminStaff_Return" ); ?>
</a>
