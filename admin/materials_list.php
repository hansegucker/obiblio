...
?>
<a href="../admin/materials_new_form.php?reset=Y"><?php echo $loc->getText("admin_materials_listAddmaterialtypes"); ?></a>
<br>
    ...
    foreach ($dms as $dm) {
        ...
        <tr>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <a href="../admin/materials_edit_form.php?code=<?php echo HURL($dm->getCode()); ?>"
                   class="<?php echo H($row_class); ?>"><?php echo $loc->getText("admin_materials_listEdit"); ?></a>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <?php if ($dm->getCount() == 0) { ?>
                    <a href="../admin/materials_del_confirm.php?code=<?php echo HURL($dm->getCode()); ?>&amp;desc=<?php echo HURL($dm->getDescription()); ?>"
                       class="<?php echo H($row_class); ?>"><?php echo $loc->getText("admin_materials_listDel"); ?></a>
                <?php } else {
                    echo $loc->getText("admin_materials_listDel");
                } ?>
            </td>
            <td valign="top" nowrap="true" class="<?php echo H($row_class); ?>">
                <a href="../admin/custom_marc_view.php?materialCd=<?php echo HURL($dm->getCode()); ?>"
                   class="<?php echo H($row_class); ?>"><?php echo $loc->getText("MARC Fields"); ?></a>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <?php echo H($dm->getDescription()); ?>
            </td>
            <td valign="top" class="<?php echo H($row_class); ?>">
                <img src="../images/<?php echo HURL($dm->getImageFile()); ?>" width="20" height="20" align="middle"
                     alt="<?php echo H($dm->getDescription()); ?>">
...
<table class="primary">
    <tr>
        <td valign="top" class="noborder"><font
                    class="small"><?php echo $loc->getText("admin_materials_listNote"); ?></font></td>
